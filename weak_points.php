    ...
    <aside class="w-64 flex-shrink-0 bg-white dark:bg-[#1C212E] p-4">
        <div class="flex flex-col gap-8">
            ...
            <nav class="flex flex-col gap-2">
                <a href="dashboard.php" class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-background-dark">
                ...
                <a href="weak_points.php" class="flex items-center gap-3 px-3 py-2 rounded-lg bg-primary/20 dark:bg-primary/20 text-primary dark:text-white">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div class="lg:col-span-4 flex flex-col gap-6">
                    <div class="flex flex-col gap-3">
                        <p class="text-slate-900 dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Weak points</p>
                    ...
                    <form id="weakPointsForm" class="flex flex-col gap-4">
                        ...
                        <label class="flex flex-col w-full">
                            ...
                            <textarea 
                                ...
                                placeholder="e.g., Include word problems, no equations with two variables..."></textarea>
                        </label>

                        <div class="flex flex-col sm:flex-row flex-1 gap-3 flex-wrap justify-start pt-2">
                            <button 
                                type="submit"
                                class="flex flex-1 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 transition-colors">
